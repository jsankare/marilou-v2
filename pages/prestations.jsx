...
const Prestations = () => {
    return (
        <Container>
            ...
            <Header image="/images/prestationsbackground.webp" title="Prestations" subtitle="La plus petite des bonnes actions envers un animal est un pas vers la construction d'un monde meilleur." author="Richard Carlson" />
            <Wrapper>
                <Individuals>
